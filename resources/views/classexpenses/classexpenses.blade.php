                    ...
                    <div class="card-body">
                        <div class="card-header bg-white border-0 justify-content-end">
                            ...
                            <div class="row justify-content-end">
                                <a href="{{ route('classexpenses.create') }}" class="btn btn-icon btn-3 btn-primary btn-outline-primary"
                                    ...
                                    @foreach ($classexpenses as $type)
                                        <tr>
                                            ...
                                            <td class="justify-content-center">
                                                <a class="btn btn-outline-primary" href="{{ route('classexpenses.show' , $type->id ) }}"><i class="fas fa-edit"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
