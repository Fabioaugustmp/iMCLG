                    ...
                    <div class="card-body">
                        <div class="card-header bg-white border-0 justify-content-end">
                            ...
                            <div class="row justify-content-end">
                                <a href="{{ route('statusproperties.create') }}" class="btn btn-icon btn-3 btn-primary btn-outline-primary"
                                    ...
                                    @foreach ($statusproperties as $status)
                                        ...
                                        <tr>
                                            ...
                                            <td class="justify-content-center">
                                                <a class="btn btn-outline-primary" href="{{ route('statuspropertie.show', $status->id) }}"><i class="fas fa-edit"></i>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
